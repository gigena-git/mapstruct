 ...
 */
@IssueKey("2504")
class ToMapMappingTest {

    @Nested
    @WithClasses({
        BeanToStringMapMapper.class
    })
    class StringMapToBeanTests {

        @ProcessorTest
        void fromNullOrder() {
            // Map<String,String> orderMap = BeanToStringMapMapper.INSTANCE.toMap(null);
            // assertThat(orderMap).isNull();
            assertThat( BeanToStringMapMapper.INSTANCE.fromMap( null ) ).isNull();
        }

        @ProcessorTest
        void fromEmptyOrder() {
            // BeanToStringMapMapper.Order order = BeanToStringMapMapper.INSTANCE.fromMap( Collections.emptyMap() );
        ...
        void fromFullOrder() {
            ...
            // BeanToStringMapMapper.Order order = BeanToStringMapMapper.INSTANCE.fromMap( map );
        ...
        @ProcessorTest
        void fromOrderWithEmptyValuesForString() {
        ...
        @ProcessorTest
        void fromOrderWithEmptyValuesForDouble() {
            // Map<String, String> map = Collections.singletonMap( "price", "" );
            // assertThatThrownBy( () -> BeanToStringMapMapper.INSTANCE.fromMap( map ) )
            //     .isInstanceOf( NumberFormatException.class );
        }

        @ProcessorTest
        void fromOrderWithEmptyValuesForDate() {
        ...
        @ProcessorTest
        void fromOrderWithEmptyValuesForLocalDate() {
